    ...
    <div>
      ...
      <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-28">
        ...
        <div className=" inline-block justify-center items-start gap-6">
          ...
          <p className="mt-20 mb-3 font-semibold text-xl text-gray-600">
            Careers at Forever
          </p>
          <p className="text-gray-500">
            Learn more about out teams and job openings.
          </p>
          <button className="mt-7 border border-black px-8 py-4 text-sm hover:bg-black hover:text-white transition-all duration-500 rounded-lg">
            Explore Jobs
          </button>
        </div>
      </div>
